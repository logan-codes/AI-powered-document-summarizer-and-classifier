...
export async function middleware(request: NextRequest) {
  ...
  // Do not run middleware on public assets or the home page
  if (
  ...
  // If you are using supabase.auth.getUser(), it will also be helpful to ensure that the response reflects that the user is logged in.
